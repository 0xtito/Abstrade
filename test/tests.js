  ...
  describe("Test functionality directly from the owner EOA", () => {
    ...
    it("should add a new order", async () => {
      await limitOrderAccount
        ...
        .createLimitOrder(token_out, token_in, expiry, order_amount, rate);
    ...
    it("should partially fill an existing order buying native xDAI", async () => {
        await limitOrderAccount
          .connect(loa_contract_owner)
          .createLimitOrder(
            token_out,
