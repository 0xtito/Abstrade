...
const OrderBook: FunctionComponent<OrderBookProps> = ({ windowWidth, productId, isFeedKilled }) => {
  ...
  const buildPriceLevels = (levels: number[][], orderType: OrderType = OrderType.BIDS): any => {
