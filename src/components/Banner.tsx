...
export default function Banner() {
  ...
  return (
    ...
    //     show
    //       ? "relative isolate flex items-center gap-x-6 overflow-hidden bg-gray-50 py-2.5 px-6 sm:px-3.5 sm:before:flex-1"
    //       : "hidden isolate relative items-center gap-x-6 overflow-hidden bg-gray-50 py-2.5 px-6 sm:px-3.5 sm:before:flex-1"
    //   )}
    // >
    //   <svg
    //     viewBox="0 0 577 310"
    ...
    <div
      className={classNames(
        show
          ? "flex items-center gap-x-6 bg-indigo-600 py-2.5 px-6 sm:px-3.5 sm:before:flex-1"
          : "hidden items-center gap-x-6 bg-indigo-600 py-2.5 px-6 sm:px-3.5 sm:before:flex-1"
      )}
    >
      <p className="text-sm leading-6 text-white">
        <div
          ...
          onClick={() =>
            window.open(
              "https://github.com/0xtito/Abstrade",
              "_blank",
              "noopener,noreferrer"
            )
          }
        >
          <strong className="font-semibold">Scaling Ethereum 2023</strong>
          <svg
            viewBox="0 0 2 2"
            className="mx-2 inline h-0.5 w-0.5 fill-current"
            aria-hidden="true"
