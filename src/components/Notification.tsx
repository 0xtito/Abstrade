...
export function Notification(props: NotifcationProps) {
  ...
  const handleSeeTransaction = (tx: string) => {
    window.open(
      `https://gnosisscan.io/tx/${tx}`,
      "_blank",
      "noopener,noreferrer"
    );
    setShow(false);
    if (setOrderCreated) setOrderCreated(false);
    if (setOrderFulfilled) setOrderFulfilled(false);
  };
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3 w-0 flex-1 pt-0.5">
                    ...
                    <p className="mt-1 text-sm text-gray-500">
                      Your order is on the Gnosis Chain. Click below to see the
                    ...
                    <div className="mt-3 flex space-x-7">
                      <button
                        ...
                        onClick={() => handleSeeTransaction(tx)}
                      >
                        See Transaction
                      </button>
                    </div>
